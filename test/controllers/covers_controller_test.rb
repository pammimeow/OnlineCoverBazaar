...
class CoversControllerTest < ActionController::TestCase
  ...
  test "should create cover" do
    assert_difference('Cover.count') do
      post :create, cover: { desc: @cover.desc, device: @cover.device, name: @cover.name, price: @cover.price }
    end
  ...
  test "should update cover" do
    patch :update, id: @cover, cover: { desc: @cover.desc, device: @cover.device, name: @cover.name, price: @cover.price }
    assert_redirected_to cover_path(assigns(:cover))
  end
